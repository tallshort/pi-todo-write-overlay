...
- [ ] Preserve the latest state when `todo_write` updates while the overlay is opening.
- [ ] Keep the active task visible for long task lists; define completed-task folding behavior.
